...
export const MailButton: React.FC = () => {
  return (
    <button
      className="flex h-10 w-10 items-center justify-center rounded-lg border border-solid border-gray-300 transition hover:bg-[#2E323B] border-[#FFFFFF] hover:border-[#2563EB] group"
    ...
    >
      ...
      >
        <path
          className="stroke-[#FFFFFF] group-hover:stroke-[#2563EB]"
...
export const LinkedinButton: React.FC = () => {
  return (
    <button
      className="flex h-10 w-10 items-center justify-center rounded-lg border border-solid border-[#FFFFFF] hover:border-[#2563EB] transition hover:bg-[#2E323B] group"
    ...
    >
      ...
      >
        <path
          className="stroke-[#FFFFFF] group-hover:stroke-[#2563EB] fill-[#FFFFFF] group-hover:fill-[#2563EB]"
